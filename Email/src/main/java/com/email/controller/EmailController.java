...
import com.email.services.EmailRepository;
...
public class EmailController {
    ...
    @PostMapping
    public EmailDTO newEmail(@RequestBody EmailDTO e){return emailServices.save(e);}
    @GetMapping
    ...
    public void deleteEmail(@RequestParam int id) {emailServices.delete(id);}
    @PutMapping(path = "{id}")
