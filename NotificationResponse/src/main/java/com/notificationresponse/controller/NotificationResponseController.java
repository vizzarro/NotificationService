...
public class NotificationResponseController {
    ...
    public NotificationResponseDTO newNotificationResponse(@RequestBody NotificationResponseDTO n) {
    ...
    @GetMapping
    public List<NotificationResponseDTO> getAllResponse() {
        return notificationResponseServices.findAll();
    }

    @GetMapping(path = "{id}")
    public NotificationResponseDTO getResponse(@PathVariable(value = "id") int id) {
        return notificationResponseServices.findById(id);
    }

    @DeleteMapping(path = "{id}")
    public void deleteResponse(@PathVariable(value = "id") int id) {
        notificationResponseServices.delete(id);
    }
